...
export default function AddPassword(props) {
  ...
  function addPasswordProcess() {
    if (urlData && nameData && passwordData) {
      dispatch(addPassword(urlData, nameData, passwordData)).then(() => {
        history.push("/");
      });
    } else {
            ...
            <div className="row justify-content-center">
              <div className="col-12 col-md-10 col-lg-9">
                <div className="add-password-container">
                  <p
                    data-testid="addPassword-title"
                    className="add-password-container--title"
                  >
                    Add new password | or anything what you like
                  </p>
                  <div className="row">
                    <div className="col-12 col-md-6">
                      <div
                        data-testid="addPassword-form"
                        className="add-password-container--input"
                      >
                        <div
                          data-testid="addPassword-url"
                        ...
                        <div
                          data-testid="addPassword-username"
                          className="add-password-container--w100"
                        >
                          <p>Username:</p>
                          <input
                        ...
                        <div
                          data-testid="addPassword-password"
                          className="add-password-container--w100"
                        >
                          <p>Password:</p>
                          <input
