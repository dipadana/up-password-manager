...
import { getPasswordDetail, editPasswordProcess,deleteProcess } from '../../store/action'
...
export default function AddPassword (props) {
  ...
  useEffect(() => {
    dispatch(getPasswordDetail(params.id))
    .then(data => {
  ...
  function handleEditPasswordProcess () {
    if(urlData && nameData && passwordData){
      ...
      dispatch(editPasswordProcess(urlData,nameData,passwordData,params.id))
      .then(() => {
            ...
            <div className="row justify-content-center">
              <div className="col-12 col-md-10 col-lg-9">
                <div className="add-password-container">
                  <p data-testid="editPassword-title" className="add-password-container--title">Edit password</p>
                  <div className="row">
                    <div className="col-12 col-md-6">
                      <div data-testid="editPassword-form" className="add-password-container--input"> 
                        <div data-testid="editPassword-url" className="add-password-container--w100">
                          <p>URL:</p>
                        ...
                        <div data-testid="editPassword-username" className="add-password-container--w100">
                          <p>Username:</p>
                        ...
                        <div className="add-password-container--w100">
                          <p>Password:</p>
                          <input data-testid="editPassword-password" id="password" value={passwordData} onChange={ e => changePasswordHandle(e.target.value) } className="add-password-container--input--input-bar" required placeholder="master password" type="password"/>
                          <div className="mt-3">
                    ...
                    <div className="d-flex justify-content-center add-password-container">
                      <button onClick={ handleEditPasswordProcess } className="add-password-container--add-password-btn mr-2">Edit Password</button>
                      <button onClick={ deleteData } className="add-password-container--add-password-btn-delete mr-2">Delete Password</button>
                    </div>
                  </div>
                </div>
              </div>
