  ...
  let data = [
    {
      ...
      UserId: {
        ...
        password:
          "$2a$10$BdC/ANoGLp6hjPxrqpiVe.Ge7/kAizO5gGicvS1uJCbp1iiKiaHsG",
...
export const loginProcess =
  (email, password, history, location) => async (dispatch) => {
    let data = {
      access_token:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImRpcGFkYW5hIiwiZW1haWwiOiJkaXBhZGFuYUBnbWFpbC5jb20iLCJfaWQiOiI1ZGUzOWI5MzE5MzBlZDFjMzQ3NGJjOWYiLCJpYXQiOjE1NzUyNDQ3MDd9.uSMNpZuyNgXurMpUQwAmw6v8QdvkvZnJKhTc5VTCvC4",
      username: "dipadana",
      email: "dipadana@gmail.com",
    };
